...
BarWidget {
  ...
  Component {
    ...
    Item {
      ...
      readonly property int drawerBlockWidth: expandIcon.implicitWidth + root.drawerExtent
  ...
  Component {
    ...
    Item {
      ...
      readonly property int drawerBlockHeight: expandIcon.implicitHeight + root.drawerExtent
